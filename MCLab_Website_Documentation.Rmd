...
- set up Git and GitHub access on macOS;
...
| `publications/index` | Single publications page, organized by year | Its rendered content is visible |
...
Complete this section once on each Mac used to edit the website.
...
The current website uses **one publications page**, `publications/index`, with publications grouped manually under year headings. Do not create a separate page for each year unless the lab intentionally changes the architecture.

1. Open `publications/index`.
...
> **Screenshot placeholder — publication:** Insert before-and-after screenshots of the relevant year in `publications/index` and the rendered Publications page.
