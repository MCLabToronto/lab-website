...
**Shared prerequisite: create a GitHub account**
...
```{bash}
sudo dnf install git openssh-clients
```
...
Check whether an appropriate GitHub key already exists before creating a new one:
...
Choose a suitable folder and clone the repository:
...
> **Screenshot placeholder — Linux:** Insert screenshots of Git installation, the SSH test, and the project open in RStudio on Linux.
